# Documentation for the PackageManager script.
...
#### [`CPU-Z`](https://www.cpuid.com/softwares/cpu-z.html) Views information about your CPU's tempurature and technologies.
...
#### [`Mercury (currently unavalible)`](https://thorium.rocks/mercury) A fork of Firefox that aims for speed and privacy.
...
#### [`Java`](https://www.java.com/en/) Installs JRE runtime, a tool which contains a server and a console for running Java apps.
